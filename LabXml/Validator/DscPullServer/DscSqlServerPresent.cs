...
namespace AutomatedLab.Validator.FailoverCluster
{
    class DscSqlServerPresent : LabValidator, IValidate
    {
        ...
        public override IEnumerable<ValidationMessage> Validate()
        {
            ...
            var sqlServers = lab.Machines.Where(m => m.Roles.Where(r => r.Name == Roles.SQLServer2016 || r.Name == Roles.SQLServer2017 || r.Name == Roles.SQLServer2019 || r.Name == Roles.SQLServer2022).Count() > 0);
